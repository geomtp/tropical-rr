...
%TODO: 
We can also prove this from that every
$\omega_{\opn{std}}$ represents the radiance obstruction of $B_0$
\cite[Theorem 7.5]{} 
and the
 following commutative diagram
induced from Leray spectral sequence: 
\begin{equation}
\begin{tikzcd}
0 \arrow[r] & H^{2}(B_0;\mathbb{Z}) \arrow[d] \arrow[r] & 
\opn{Ker}(H^{2}(\check{X}(B_0);\mathbb{Z})\to 
H^{0}(B_0;\bigwedge^{2}\mathcal{T}_{\mathbb{Z},B_0})) 
\arrow[d] \arrow[r] & H^{1}(B_0;\mathcal{T}_{\mathbb{Z},B_0}) 
\arrow[d] \arrow[r] & 0 \\
0 \arrow[r] & H^{2}(B_0;\mathbb{R}) \arrow[r]           & 
\opn{Ker}(H^{2}(\check{X}(B_0);\mathbb{R})\to 
H^{0}(B_0;\bigwedge^{2}\mathcal{T}_{B_0}))
\arrow[r] & 
{H^{1}(B_0;\mathcal{T}_{B_0})} \arrow[r]           & 0.
\end{tikzcd}
\end{equation}
The above both row is exact.
\begin{example}
This 
\end{example}
