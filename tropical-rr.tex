...
The similarity of $X_0(C)$ and $M$ is evident,
...
an integral affine manifold, since $B=B_{\mathrm{reg}}$.
...
$\chi(\opn{LMD}^{\bullet}(B,s))=
\chi_{\opn{top}}(B)=0$ is 
truly a special case of microlocal Poincar\'e--Hopf theorem for $B$.
...
If $B$ is an integral affine manifold such 
that $\pi_2(B)=0$, then $\pi_2(\check{X}(B))=0$.
...
of $B$ has a ($\mathbb{Z}/2\mathbb{Z}$-graded)
...
$\pi_{2}(B)=0$ if Markus conjecture 
is true.
\end{remark}
