...
we can choose sufficently small compact neighborhood 
of $x$.  
...
$\partial \bar{B}(x,\varepsilon) \cap f^{-1}(f(x))$ 
intersect transversely \cite[Part I.3.5.1. Lemma]{MR932724},
and thus $\partial \bar{B}(x,\varepsilon) \cap f^{-1}(f(x))$
...
f^{-1}(f(x))\cap \bar{B}(x,\epsilon)\setminus \{f(x)\}) \\
\simeq & ((0,\epsilon] \times \partial \bar{B}(x,\varepsilon),
(0,\epsilon] \times
(\partial \bar{B}(x,\varepsilon) \cap f^{-1}(f(x)))).
\end{align}
...
\tilde{H}^{\bullet-1}(\partial \bar{B}(x,\varepsilon) 
\cap \{f<f(x)\};A).
\end{align}
...
$\opn{LMD}^{\bullet}(\mathbb{Z}_S,-f|_S,x)\simeq H^{n}(S,S\setminus\{x\},
\mathbb{Z})[-n]$ since every Bergman fan has a good subdivision 
...
(\opn{SS}(S)_x)=(\mathcal{F}_{S}^{1})_x$,
