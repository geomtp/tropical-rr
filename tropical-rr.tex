...
\end{conjecture}
The \cref{condition-Rn} is for simplicity 
of the definition $C^{\infty}$-Cartier divisor.
...
We note that our results has highly related with 
 \cite{MR4301560} and \cite{auroux2022lagrangian} (see \cref{rmk: curve_mirror} and \cref{rmk: integral_mirror} 
...
\cite[Corollary 4.1]{MR1461965} by using 
