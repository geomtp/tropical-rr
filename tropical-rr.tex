...
$\bar{B}(x,\varepsilon)$ (resp. $B(x,\varepsilon)$)  
the closed (resp. open) ball with radius 
$\varepsilon\in \mathbb{R}_{>0}$ and 
center $x\in \mathbb{R}^{n}$. Then, 
\begin{align}
\opn{LMD}(A_{\mathbb{R}^{n}},f,x)\simeq 
\opn{LMD}(A_{B(x,\varepsilon)},f|_{B(x,\varepsilon)},x) \simeq 
\opn{LMD}(A_{\bar{B}(x,\varepsilon)},
f|_{\bar{B}(x,\varepsilon)},x).
\end{align}

If $f$ is smooth and has an isolated \emph{nondepraved} 
critical point at $x$, then 
$f^{-1}(f(x))\setminus \{x\}$ is a smooth submanifold 
and $\{f^{-1}(f(x))\setminus \{x\},\{x\} \}$ induces 
a stratification satisfying Whitney's condition B
\cite[Part I.2.5.1. Lemma]{MR932724}. 
Let 
$r\colon \mathbb{R}^{n}\to \mathbb{R};(x_1,\ldots ,x_n)
\to \sum_{i=1}^{n}x_i^{2}$
and $S(x,\varepsilon)\deq \partial \bar{B}(x,\varepsilon)$.
For sufficiently small $\varepsilon$, 
$S(x,\varepsilon) \cap \{f=f(x)\}$ 
intersect transversely \cite[Part I.3.5.1. Lemma]{MR932724},
and thus $S(x,\varepsilon) \cap \{f=f(x)\}$
is also a submanifold and compact.
A relative version of Ehresmann's lemma induces the 
homeomorphism the following pairs of smooth manifold 
with boundary:
\begin{align}
&(\bar{B}(x,\varepsilon)\setminus \{x\}, 
 \bar{B}(x,\epsilon)\cap \{f=f(x)\} \setminus \{x\}) \\ 
\simeq & ((0,\epsilon] \times S(x,\varepsilon),
(0,\epsilon] \times
(S(x,\varepsilon) \cap \{f=f(x)\})). \notag
\end{align}
...
topological spaces:
\begin{align}
(\bar{B}(x,\varepsilon),\bar{B}(x,\varepsilon)\cap \{f=f(x)\})
\simeq (\opn{Cone}(\partial \bar{B}(x,\varepsilon)),
\opn{Cone}(S(x,\varepsilon) \cap \{f=f(x)\})).
\end{align}
...
\begin{align}
\opn{LMD}^{\bullet}(A_{\bar{B}(x,\varepsilon)},
f|_{\bar{B}(x,\varepsilon)},x)\simeq 
\tilde{H}^{\bullet-1}(S(x,\varepsilon) 
\cap \{f<f(x)\};A).
\end{align}
...
$r(x)\deq \sum_{i=1}^{n}x_i^{2}-\varepsilon$.
Then, 
\begin{align}
\opn{SS}((k_{U})_{\bar{B}(0,\epsilon)})=
\{(x;cdr(x))\in T^*U\mid x\in \bar{B}(x,\epsilon), 
c\in \mathbb{R}_{\geq 0}\}.
\end{align}

Therefore, if $f|_{S(0,\varepsilon)}$ is 
a Morse function, then by 
...
\begin{align}
(R\Gamma_{\{\psi(x)\geq \psi(x_1)\}}(\mathcal{F}^{\bullet}|_V))_{x_1}
\simeq 0.
\end{align}
...
(\opn{LC}_x S/\opn{Lin}(\opn{LC}_x S))$, we have
\begin{align} 
