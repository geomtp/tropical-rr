...
explaining and answering question about the radiance obstructions, eigenwaves,
and Gross--Siebert
...
the dependence of the micro-support $\opn{SS}(\mcal{F})$ is solely 
on the $C^{1}$-structure of $X$ \footnote{この一文ほぼ丸々引用の文だけどだい
大丈夫?}
, and the forgetful functor 
$\phi_X \colon \opn{D}^{b}(A_X)\to \opn{D}^{b}(\Z_X)$
preserves the micro-support of $\mcal{F}$ 
