...
In particular, $(R\Gamma_{Z}(i_*\mcal{F}))_v
  \simeq (R\Gamma_{Z\cap S}\mcal{F})_v$ for $v\in Y$.
\end{enumerate}
...
\begin{align}
(R\Gamma_{\{\psi(x)\geq 0\}}(\mathcal{F}^{\bullet}))_{x_1}
\simeq 0.
\end{align}
...
A \emph{intersection data} of $s$ is the set 
