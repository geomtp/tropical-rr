...
\item Let $f\colon [0,\infty) \to \mathbb{R}$ be a
$(0,0)$-superform on $[0,\infty)$. Then, 
$f$ is admissible at $x=0$ if and only if 
$df(x)\in \mathbb{Z}^{\vee}$.
\end{enumerate}
\end{proposition}
...
and Meyer--Vietoris exact sequence, we get 
