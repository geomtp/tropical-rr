...
a polyhedral complex $\Sigma$ in $X$ whose contains $x$.
...
$\mathbb{R}^{n}$ such that $x+s\in S$ for all 
$s\in S$ and $x\in V$, i.e.,
\begin{align}
Z+V=Z.
\end{align}
...
with a trivalent metric graph \cite{auroux2022lagrangian}
as a set.
\end{example}
