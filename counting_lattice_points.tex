...
$\check{X}_0(\mathbb{T}P^{1})$ is just a 
cylinder with infinity length plus two infinity points:
\begin{align}
...
induces the canonical automorphism:
\begin{align}
