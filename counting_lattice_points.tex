...
$D^{\pi}_{\infty}(\opn{Fuk}(\check{X}))\simeq 
D^{b}_{\infty}(\opn{Coh}(X))$.
...
(\mcal{L}_1,\mcal{L}_2\otimes \mcal{K}_X)).
\end{align}
If $X$ is Calabi--Yau, then this is compatible with
...
about Noether formula for general cases.
}
\item 
...
\subsubsection{Relationships between a localization of 
