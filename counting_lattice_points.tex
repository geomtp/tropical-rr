...
cup product of each $H^{q}(X;\mcal{F}_{\mathbb{Z},X}^{p})$.
...
& \mathcal{O}_X^{\times} \arrow[r] \arrow[d] &
...
H^{1}(X;\mathcal{F}_{\mathbb{Z},X}^{1}); s\mapsto D_s \mapsto c_1(s).
\end{align}
...
In this case, the Masolov index
is equal to the 
