...
$\opn{LMD}(\mcal{F},f,x)\deq (R\Gamma_{\{f\geq f(x)\}}(\mcal{F})_x$
...
which does not satisfy stratified Morse condition. 
\end{Rmk}
...
tropical homology. We follow about tropical homology 
from \cite{MR1853077,gross2019sheaftheoretic}
