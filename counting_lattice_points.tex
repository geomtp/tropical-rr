...
varieties and this gives a tropically interpretation 
of the wrapped Fukaya category for the mirror of
toric varieties in \cite{MR2871160}.
For instance, let $U_{x}$ be a small open neighborhood of 
a given point $x$ in a tropical toric strata $X_{\sigma}$
 corresponds to a convex cone $\sigma$ of a fan.
Then, the slope of a smooth function $f$ on $U_{\sigma}$ at $x$
...
the condition $df(x)\in\sigma^{\bot}$ gives 
