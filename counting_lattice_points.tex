...
$(\C^{\times})^{d}$ and the derived wrapped Fukaya category of $T^{*}(S^{1})^{n}$
by \cite{MR2822213}.
...
Let $P$ be a $d$-dimensional lattice polytope in 
$\mathbb{R}^{d}$, $X_P$ the projective toric variety
of $P$, $\mathcal{L}_P$ the line bundle on 
$X_P$ of $P$
 and $P(\mathbb{Z})\deq P\cap \Z^{d}$.
...
Therefore, $\chi(Z_w,\mathcal{O}_{Z_w})=
\chi_{\opn{top}}(B)$.
\end{enumerate}
...
\begin{align}
\chi(C,s)=\int_C c_1(D_s)+\frac{1}{2}c_1(-K_C), \quad \chi(B,s)=\int_B \frac{c_1(D_s)^{n}}{n!}
\end{align}
...
the following microlocal index theroem:
