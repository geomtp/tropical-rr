...
(see 
\cite[1.3]{mikhalkinTropicalEigenwaveIntermediate2014a} and \cite[Definition 2.16]{}).
\end{condition}
See also \cite[Example 3.3]{mikhalkinTropicalEigenwaveIntermediate2014a} and 
\cite[Remark 2.21]{} for the wave tangent space
...
From elementary properties of adjoint functors,
every morphism 
$f\colon Ra_{!}\upomega_X\to A_{\{\mathrm{pt}\}}$
