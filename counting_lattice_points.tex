...
$\mathbb{P}(\mathbb{T}^{n})$ has a canonical inclusion
$\iota_n\colon \mathbb{R}^{n-1}\to 
\mathbb{P}(\mathbb{T}^{n})=\mathbb{T}P^{n-1}$ 
...
\footnote{We also thanks 
for explaining us a heart of localization of 
Dirac-type operators and answering some 
questions about it.}
...
We also stress that both method of computation
