...
\begin{Rmk}
  If $B_0$ is not an Hessian manifold, then we cannot apply the above proof
...
induces the following commutative diagram \footnote{Several similar diagrams appear
  in literature}:
