...
(i) Let $j:V\to X$ be an open inclusion and $Z$ be a 
closed subset of $X$.
...
\begin{Eg}[Singular cohomology v.s. constant sheaf cohomology]
  ...
  A proof of this isomorphism is in \href{https://arxiv.org/abs/1602.06674}{[1602.06674] Comparison of sheaf cohomology and singular cohomology}.
\end{Eg}
...
See \href{https://arxiv.org/abs/math/0409520}{[math/0409520] Lectures on Arithmetic Noncommutative Geometry}
for Schottky uniformization.

\subsection{GW invariant}
The Gromov--Witten invariant $N_d$ is equal to the number of rational 
curve with marked $n$-points.
(See [Theorem 7.3.1,Cox--Katz])
